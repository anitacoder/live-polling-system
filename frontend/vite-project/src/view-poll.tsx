...
function ViewPollPage() {
  ...
  return (
    <>
      <button className="view-history-btn" onClick={() => navigate("/view-poll-history")}>
      ...
      <div className="question-container">
        ...
        <button className="submit-btn">+Ask a new question</button>
      </div>
